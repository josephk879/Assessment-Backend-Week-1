...
| `/history`     | `GET`    | Optional query parameter:<br />- `number` (the number of requests to return; default 5, 1<=number<=20)                                       | `[ {"method": "POST", "at": "12/02/2023 18:39", "route": "weekday"}, {"method": "POST", "at": "12/02/2023 18:36", "route": "weekday"}]` | Returns details on the last `number` of requests to the API |
